        ...
        <div className="contact-left-enhanced">
          <div className="social-card email-card">
            <div className="social-info">
              ...
              <div>
                <h4>Email</h4>
                <p>tusharsharmaprayagraj@gmail.com.com</p>
              </div>
            </div>
            <a href="mailto:tusharsharma@example.com" className="social-btn red">
              Message <FaEnvelope />
            </a>
          </div>
          ...
          <div className="social-card whatsapp-card">
            ...
            <a href="https://wa.me/91XXXXXXXXXX" target="_blank" rel="noreferrer" className="social-btn green">
              Message <FaWhatsapp />
            </a>
          </div>
        </div>
